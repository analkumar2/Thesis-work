# exec(open('plot_150vs300pA.py').read())

# Plots to see offset increase as current clamp level is increased
...
CurrAmp = 20 #0 is for -100pA, 1 for -75pA, and so on till 20 which is 400pA. 10 for 150pA
...
for filename in flist:
    ...
    try: #Try is used to skip unsupported files that may be there in the folder
        ...
        plt.plot(np.linspace(0,Tdur+0,Samprate*Tdur), seg.analogsignals[0], label = '400pA')
