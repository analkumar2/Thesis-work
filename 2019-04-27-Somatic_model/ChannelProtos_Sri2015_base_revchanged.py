#exec(open('Srikanth2015/ChannelProtos_Sri2015_base_revchanged.py').read())
...
def K_BK_Chan(name):
    ...
    with open("Channels/K_BK_Chan_tableA.txt", "rb") as fp:
        zgate.tableA = pickle.load(fp)

    with open("Channels/K_BK_Chan_tableB.txt", "rb") as fp:
        zgate.tableB = pickle.load(fp)
