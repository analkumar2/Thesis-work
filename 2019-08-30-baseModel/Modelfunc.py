...
def Modelfunc(runfor='2', stimul='Vclamp', gl = 0.25, Ca_concCaBasal='0.05e-3', Ca_L_changbar='3', Ca_N_changbar='3', Ca_T_changbar='3', h_changbar='0.25', K_A_changbar='30', K_BK_changbar='8', K_D_changbar='0.05', K_DR_changbar='3', K_M_changbar='1.1', K_SK_changbar='1', Na_changbar='1000'):
    global Em
    try:
    ...
    if stimul == 'Vclamp':
        stimuli = ['soma', '1', '.', 'vclamp', f'{Vleveli} + (t>{preStimTime} && t<{preStimTime+injectTime}) * {Vlevelf}' ]
    elif stimul == 'Iclamp':
    ...
    #         ['Na_chan', 'soma', 'Gbar', Na_changbar],
    #     ],
    #     stimList = [['soma', '1', '.', 'inject', f'(t>={preStimTime} && t<={preStimTime+injectTime}) ? {Injectcurr} : 0']
    #     ],
    #     plotList = [
    #         ['soma', '1', '.', 'Vm', 'Soma Membrane potential MOOSE'],
    #         ['soma', '1', 'vclamp', 'current', 'Soma holding current MOOSE'],
