# exec(open('../../Compilations/Kinetics/K_SK_Chan_Custom3.py').read())
# Migliore2018 kinetics. Parameterized but since this uses Ca, not by  alge
...
#################################
cac, hillcoeff, beta = 0.00035, 4, 0.03
#################################
...
def SKChanGate(ca, cac, hillcoeff, beta):
...
def K_SK_Chan(name):
    ...
    [mInf, mTau] = SKChanGate(ca, cac, hillcoeff, beta)
