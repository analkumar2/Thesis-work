# L type calcium channel cal.mod Markaki2015. (The s part is ignored)
# exec(open('Ca_L_Chan_Custom2.py').read())
...
###############################
m_vhalf_inf, m_slope_inf, m_tau = -0.001, 0.0057, 1.5e-3
ki = 0.025
###############################
...
def ChanGate2(v,vhalf_inf, slope_inf, tau):
    # alge model
...
def Ca_L_Chan(name):
    ...
    [mInf, mTau] = ChanGate2(v,m_vhalf_inf, m_slope_inf, m_tau)
