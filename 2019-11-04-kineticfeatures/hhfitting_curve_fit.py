...
def kineticfunc(t, Gbar, minfV, mtauV, hinfV, htauV, min, hin):
...
levelnum = 10
fittedparam, cov = curve_fit(kineticfunc, np.arange(0,len(G[levelnum])/10000,1/10000), G[levelnum]*1e8, p0=[2,1,0.005,0.25,0.046,0,1], bounds=([0,0,0.0001,0,0.0001,0,0],[100,1,1,1,1,1,1]))
