...
def somefeatures(currAmp,Vtrace,stim_start,stim_end,sampling_rate):
    ...
    features[f'freq'] = len(scs.find_peaks(Vtrace, height=-0.03)[0])/(stim_end - stim_start)
...
for i in range(num_of_iterations):
    ...
    if Model['Error']<errorthreshold and features['freq']>=6 and features[f'offset']>0:
        print(Model)
        print('\n')
