...
Model['parameters']['Morpholgy']={}
Model['parameters']['Morpholgy']['sm_len'] = moose.element('/model/elec/soma').length
Model['parameters']['Morpholgy']['sm_diam'] = moose.element('/model/elec/soma').diameter
