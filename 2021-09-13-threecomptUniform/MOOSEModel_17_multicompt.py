...
# v17_multicompt For model with passive soma and active AIS. In the parameterdict, specify morphology swc file. Pass gbar, cm, rm, ra instead of their absolute versions
