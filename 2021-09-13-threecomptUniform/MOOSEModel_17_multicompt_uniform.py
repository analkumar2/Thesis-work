...
# v17_multicompt_uniform For model with uniformly distributed parameters. In the parameterdict, specify morphology swc file. Pass gbar, cm, rm, ra instead of their absolute versions. vclamp does not work right now.
...
def Parameterdict_parser(Parameterdict):
    ...
    for channel in chd.keys():
        ...
        chanDistrib.append(
            [channel, "#", "Gbar", str(chd[channel]["gbar"])]
        )
