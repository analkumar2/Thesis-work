...
Cm, Rm, Em, Gbars (=gbars*sm_area), Ca_B, Ca_tau, Ca_inf
...
2. Erev for every channel - Later if it turns out that it has little effect, we'll finally consider only canonical Erevs for ex -96mV for K+
