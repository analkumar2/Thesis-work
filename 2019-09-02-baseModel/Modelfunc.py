...
def Modelfunc(runfor=2, stimul='Vclamp', Injectcurr=150e-12, gl = 0.25, Ca_concCaBasal='0.05e-3', Ca_L_changbar='3', Ca_N_changbar='3', Ca_T_changbar='3', h_changbar='0.25', K_A_changbar='30', K_BK_changbar='8', K_D_changbar='0.05', K_DR_changbar='3', K_M_changbar='1.1', K_SK_changbar='1', Na_changbar='1000'):
    global Em
    global sm_area
    ...
    rdes = rd.rdesigneur(
        ...
        chanDistrib = [
            ['Ca_conc', 'soma', 'CaBasal', Ca_concCaBasal],
    ...
    Parameters['sm_diam'] = soma.diameter
    Parameters['sm_len'] = soma.length
    Parameters['RM'] = soma.Rm*sm_area
    Parameters['CM'] = soma.Cm/(sm_area)
    Parameters['Em'] = soma.Em
    Parameters['Ca_concCaBasal'] = Ca_conc.CaBasal
    Parameters['Ca_conctau'] = Ca_conc.tau
    Parameters['Ca_concB'] = Ca_conc.B
    Parameters['Ca_L_changbar'] = Ca_L_chan.Gbar/sm_area
    Parameters['Ca_N_changbar'] = Ca_N_chan.Gbar/sm_area
    Parameters['Ca_T_changbar'] = Ca_T_chan.Gbar/sm_area
    Parameters['h_changbar'] = h_chan.Gbar/sm_area
    Parameters['K_A_changba'] = K_A_chan.Gbar/sm_area
    Parameters['K_BK_changbar'] = K_BK_chan.Gbar/sm_area
    Parameters['K_D_changbar'] = K_D_chan.Gbar/sm_area
    Parameters['K_DR_changbar'] = K_DR_chan.Gbar/sm_area
    Parameters['K_M_changbar'] = K_M_chan.Gbar/sm_area
    Parameters['K_SK_changbar'] = K_SK_chan.Gbar/sm_area
    Parameters['Na_changbar'] = Na_chan.Gbar/sm_area
    ...
    if stimul=='Vclamp':
        ...
        tvec=plott.vector
    return [Parameters, characteristics, Vmvec, Ivec, Cavec, tvec]
