# exec(open('manual_traubcompartment/traub1991_CA1.py').read())
...
rdes = rd.rdesigneur(
    ...
    stimList = [
        # ['soma', '1', '.', 'inject', '(t>=3 && t<3.003) ? 3e-9 : ((t>=3.003 && t<=3.006) ? -4e-9 : 0)' ],
        ['apical_1_5', '1', '.', 'inject', '(t>=3.0 && t<=8.003) ? 0.25e-9 : 0'],
    ],
