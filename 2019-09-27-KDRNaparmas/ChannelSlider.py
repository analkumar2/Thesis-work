...
[Parameters, characteristics, Vmvec, Ivec, tvec] = Modelfunc(runfor=runtime, stimul='Iclamp', Injectcurr=Injectcurr, gl=1/Parameters['RM'], K_DR_changbar=str(Parameters['K_DR_changbar']), Na_changbar=str(Parameters['Na_changbar']))
print(Parameters)
...
uuuae = 0
for x in np.linspace(0.5,0.1,4):
    if uuuae%2==0:
