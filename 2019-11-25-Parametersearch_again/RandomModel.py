...
moose.element("/model/elec/soma/Na_Chan").Gbar = nr.uniform(21, 85)*sm_area
moose.element("/model/elec/soma/Na_P_Chan").Gbar = nr.uniform(0.17, 0.68)*sm_area
moose.element("/model/elec/soma/K_DR_Chan").Gbar = nr.uniform(15, 64)*sm_area
moose.element("/model/elec/soma/K_D_Chan").Gbar = nr.uniform(0.00001, 0.5)*sm_area
moose.element("/model/elec/soma/K_A_Chan").Gbar = nr.uniform(0.12, 0.5)*sm_area
moose.element("/model/elec/soma/K_M_Chan").Gbar = nr.uniform(0.6, 2.5)*sm_area
moose.element("/model/elec/soma/K_SK_Chan").Gbar = nr.uniform(0.26,1.04)*sm_area
moose.element("/model/elec/soma/K_BK_Chan").Gbar = nr.uniform(0.00001, 8)*sm_area
moose.element("/model/elec/soma/h_Chan").Gbar = nr.uniform(0.16, 0.67)*sm_area
moose.element("/model/elec/soma/Ca_T_Chan").Gbar = nr.uniform(0.4, 1.6)*sm_area
moose.element("/model/elec/soma/Ca_L_Chan").Gbar = nr.uniform(0.4, 1.6)*sm_area
moose.element("/model/elec/soma/Ca_N_Chan").Gbar = nr.uniform(0.4, 1.6)*sm_area
