...
# current = moose.element('/model/graphs/plot1').vector
# b,a = signal.bessel(3, (0.001,100), btype='bandpass', analog=True)
# current_bessel = signal.filtfilt(b, a, current)
# # plt.plot(current)
# plt.plot(current_bessel)
# plt.show()
