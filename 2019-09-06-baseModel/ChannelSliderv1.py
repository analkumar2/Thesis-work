...
def update(val):
    ...
    sliders_list[10].set_val(Parametersout['K_BK_changbar'])
    sliders_list[11].set_val(Parametersout['K_D_changbar'])
    sliders_list[13].set_val(Parametersout['K_M_changbar'])
    # for s in sliders_list:
    #     s.on_changed(update)
    Parameters['Em'] = sliders_list[0].val
    Parameters['RM'] = 1/sliders_list[1].val
