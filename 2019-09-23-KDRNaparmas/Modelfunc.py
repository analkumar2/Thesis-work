...
def Modelfunc(runfor=2, stimul='Iclamp', Injectcurr=Injectcurr, gl=1/Parameters['RM'], K_DR_changbar=str(Parameters['K_DR_changbar']), Na_changbar=str(Parameters['Na_changbar'])):
