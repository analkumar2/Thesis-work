...
for i in range(num_of_iterations):
    ...
    Modeltemp['parameters']['Channels']['K_DR_Chan']['gateX'] = [nr.uniform(-0.012,0.030),nr.uniform(0.002,0.012), nr.uniform(-0.030,-0.008),nr.uniform(0.003,0.045),nr.uniform(0,0.1),nr.uniform(0,0.1),nr.uniform(0.005,0.055),nr.uniform(0.002,0.11)]
    #####################################################################
