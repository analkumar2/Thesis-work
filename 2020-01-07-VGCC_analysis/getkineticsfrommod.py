...
minf_vec.record(soma(0.5).can._ref_minf)
mtau_vec.record(soma(0.5).can._ref_mtau)
# minf_vec.record(soma(0.5).can._ref_hinf)
# mtau_vec.record(soma(0.5).can._ref_htau)
